...
func GenerateRspHead(Code int, Msg string) types.HTTPCommonHead {
	return types.HTTPCommonHead{Code: Code, Msg: Msg, RequestID: strconv.FormatInt(time.Now().Unix(), 10)}
}
